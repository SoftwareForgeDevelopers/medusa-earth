...
function BlogCard({ name, date, description, image }) {
  return (
    <div className="w-[608px] h-[552px] rounded-[30px] overflow-hidden bg-white border border-gray-300 shadow">
      <img className="w-full h-1/2 object-cover" src={image} alt={name} />
      <div className="flex flex-col p-7 gap-4">
        <div>
          <h4 className="font-w-bold text-[30px] text-var-dark-blue">{name}</h4>
