...
function IntroSection() {
  return (
    <section id="intro-section" className="flex flex-col select-none">
      <div
      ...
      <div className="flex flex-col w-full gap-3 my-9 px-6 tablet:hidden">
        <Link to="/projects">
          <Button
            type="dark-blue"
            styles="w-full h-[51px] font-w-regular"
            content="Explorá nuestros proyectos"
          />
        </Link>
        <Button
