function AttributtesCard({ type, title, description, icon }) {
  ...
  let boxClassName = "border border-solid flex flex-col items-center gap-28 rounded-xl w-392 h-289 py-48";
  let figureClassName = "w-63 h-63 flex justify-center items-center rounded-52 bg-var-grey-blue";
